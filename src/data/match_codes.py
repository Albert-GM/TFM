# =============================================================================
# script that creates dictionaries to map ISO codes of countrys and map IATA to
# country
# =============================================================================
...
# iata mapping
# only open airports and not nan
...
with open('../../data/interim/alpha3_to_alpha2.txt', 'w') as file:
